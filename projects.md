...
{% include feature_row id="feature_row_cv184x" type="left" %}
{% include feature_row id="feature_row_internship" type="left" %}
{% include feature_row id="feature_row_network" type="left" %}
{% include feature_row id="feature_row_wandering" type="left" %}
{% include feature_row id="feature_row_opr" type="left" %}
{% include feature_row id="feature_row_recognition" type="left" %}
{% include feature_row id="feature_row_rvspoc" type="left" %}
